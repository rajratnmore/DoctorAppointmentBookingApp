...
public class DoctorController {
    ...
    @GetMapping("doctors")
    public List<Doctor> getAllDoctors(@Valid @RequestBody AuthenticationInputDto authenticationInputDto){
        return doctorService.getAllDoctors(authenticationInputDto);
    }
